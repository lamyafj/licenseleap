...
class _ProfilepageWidgetState extends State<ProfilepageWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.nationalId, 0).toString());
    ...
    _model.textController3 ??= TextEditingController(
        text: dateTimeFormat('yMMMd', currentUserDocument?.dob));
            ...
            Align(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Align(
                    alignment: const AlignmentDirectional(-0.88, 0.9),
                    child: Padding(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                              .update(createClientRecordData(
                            displayName: _model.textController4.text,
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: const Text(
                                    'Success! Your updated information has been saved.'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
